...
CLASS_MESSAGES = {
    "ambient": [
        ...
        "единое целое, а не составные части. Такой тип обеспечивает быстрое распознавание базовых эмоций человека.",
        # 2
    ...
    "scanner": [
        ...
        # 2
        "Сейчас ваше восприятие склонно к <strong>фокальному</strong> типу. Что это значит? Взгляд настроен воспринимать лицо по "
